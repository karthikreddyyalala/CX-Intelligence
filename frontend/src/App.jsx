  ...
  return (
    <div className="min-h-[100dvh] relative" style={{ background: 'var(--bg)' }}>
      ...
      <main className="relative z-10 max-w-[1360px] mx-auto px-4 sm:px-6 py-8 space-y-12">
        ...
        <section>
          <SectionLabel eyebrow="02 — Talk to your customers' feedback" title="Ask anything, get an answer with evidence" accent
        ...
        {/* AI brief */}
        <section>
          <SectionLabel eyebrow="03 — What leadership should know" title="AI executive brief" accent
        ...
        {/* Focus areas */}
        <section>
          <SectionLabel eyebrow="04 — Where to focus" title="Top complaints, ranked by impact"
        ...
        {/* Cost of inaction */}
        <section>
          <SectionLabel eyebrow="05 — The business case" title="What these complaints are costing" accent
        ...
        {/* Branch performance */}
        <section>
          <SectionLabel eyebrow="06 — Location intelligence" title="The same brand, 30 different experiences" accent
        ...
        <section>
          <SectionLabel eyebrow="07 — People intelligence" title="The names customers keep repeating"
        ...
        <section>
          <SectionLabel eyebrow="08 — Identity intelligence" title="When one angry customer sounds like four" accent
        ...
        {/* Platforms */}
        <section>
          <SectionLabel eyebrow="09 — Every channel, one place" title="Platform intelligence"
        ...
        {/* Trends */}
        <section>
          <SectionLabel eyebrow="10 — Signal over time" title="Sentiment & volume trends"
        ...
        {/* Competitive context */}
        <section>
          <SectionLabel eyebrow="11 — Competitive context" title="How Avis stacks up against rivals"
        ...
        {/* Feed */}
        <section>
          <SectionLabel eyebrow="12 — The raw signal" title="Live conversation feed"
        ...
        {/* Take-away brief */}
        <section>
          <SectionLabel eyebrow="13 — Take it with you" title="This week, in one email" accent
...
function SectionLabel({ eyebrow, title, sub, accent }) {
  return (
    <div className="mb-5 max-w-[62ch]">
      ...
      {sub && <p className="mt-2 text-[14px] leading-relaxed" style={{ color: 'var(--text-dim)' }}>{sub}</p>}
    </div>
  );
}
